    ...
    return (
      <main className="min-h-screen bg-cream-50 flex items-center justify-center px-8 py-16">
        ...
        >
          ...
          <div className="bg-sage-100 rounded-xl px-6 py-5 w-full">
          ...
          >
            ...
            {step === 2 && contentType && (
              <div className="space-y-6">
                ...
                {(contentType === "text" ||
                  ...
                  <>
                    {contentType === "slow_post" && (
                      <div className="bg-sage-100 rounded-xl px-5 py-4">
                    ...
                    <div className="relative">
                      <textarea
                        ...
                        rows={6}
                        className="w-full resize-none rounded-xl bg-cream-100 px-5 py-4 font-sans text-base text-slate-warm placeholder:text-slate-hint focus:outline-none focus-visible:ring-2 focus-visible:ring-sage-400 leading-[1.7]"
                        style={{ minHeight: 120 }}
                      />
            ...
            {step === 3 && (
              <div className="space-y-8">
                ...
                <div className="space-y-2">
                  ...
                  >
                    Caption{" "}
                    <span className="text-slate-hint text-xs">
                      {isTextType ? "" : "(optional)"}
                    </span>
                  </label>
                  <div className="relative">
                ...
                <div className="space-y-4">
                  <label className="font-sans text-sm text-slate-warm">
                    How does this feel?
                  </label>
            ...
            {step === 4 && contentType && (
              <div className="space-y-8">
                ...
                {/* Preview card */}
                <div className="rounded-xl bg-cream-100 border border-cream-200 p-6 space-y-4">
                  {/* Media preview */}
                  {mediaUrls.length > 0 && (
                  ...
                  {isTextType && textContent && (
                    <p className="font-sans text-base text-slate-warm leading-[1.7]">
                      {textContent}
                    </p>
                  )}
                  ...
                  {/* Mood pill */}
                  {moodTag && (
                    <span className="inline-flex items-center rounded-full bg-sage-100 px-3 py-1 font-sans text-xs font-medium text-sage-800">
                      {moodTag}
                    </span>
                  )}
                </div>
